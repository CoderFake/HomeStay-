...
function legendClickCallback(e) {
    ...
    var a = s.parentElement, o = parseInt(a.classList[0].split("-")[0], 10), r = Chart.instances[o],
        l = Array.prototype.slice.call(a.children).indexOf(s);
    r.legend.options.onClick.call(r, e, r.legend.legendItems[l]), r.isDatasetVisible(l) ? s.classList.remove("hidden") : s.classList.add("hidden")
}
...
$(".main-header .logo-header").html(logoHeaderContent), $(".nav-search .input-group > input").focus(function (e) {
    ...
    [...s].map(e => new bootstrap.Popover(e)), layoutsColors(), customBackgroundColor()
    ...
    t.length > 0 && t.scrollbar(), $("#search-nav").on("shown.bs.collapse", function () {
    ...
    if (!c) {
        ...
        k.on("click", function () {
            1 == h ? ($("html").removeClass("nav_open"), k.removeClass("toggled"), h = 0) : ($("html").addClass("nav_open"), k.addClass("toggled"), h = 1)
        }), c = !0
    }
    if (!m) {
        var k = $(".quick-sidebar-toggler");
        k.on("click", function () {
            1 == h ? ($("html").removeClass("quick_sidebar_open"), $(".quick-sidebar-overlay").remove(), k.removeClass("toggled"), m = 0) : ($("html").addClass("quick_sidebar_open"), k.addClass("toggled"), $('<div class="quick-sidebar-overlay"></div>').insertAfter(".quick-sidebar"), m = 1)
    ...
    if (!d) {
        ...
        w.on("click", function () {
            1 == v ? ($("html").removeClass("topbar_open"), w.removeClass("toggled"), v = 0) : ($("html").addClass("topbar_open"), w.addClass("toggled"), v = 1)
        }), d = !0
    }
    if (!g) {
        var _ = $(".toggle-sidebar");
        $(".wrapper").hasClass("sidebar_minimize") && (_.addClass("toggled"), _.html('<i class="gg-more-vertical-alt"></i>'), f = 1), _.on("click", function () {
            1 == f ? ($(".wrapper").removeClass("sidebar_minimize"), _.removeClass("toggled"), _.html('<i class="gg-menu-right"></i>'), f = 0) : ($(".wrapper").addClass("sidebar_minimize"), _.addClass("toggled"), _.html('<i class="gg-more-vertical-alt"></i>'), f = 1), $(window).resize()
        }), g = !0, u = !0
    }
    if (!p) {
        var q = $(".page-sidebar-toggler");
        q.on("click", function () {
            1 == b ? ($("html").removeClass("pagesidebar_open"), q.removeClass("toggled"), b = 0) : ($("html").addClass("pagesidebar_open"), q.addClass("toggled"), b = 1)
    ...
    $(".wrapper").hasClass("is-show") && (C = 1, y.addClass("toggled"), y.html('<i class="icon-options-vertical"></i>')), y.on("click", function () {
        1 == C ? ($(".wrapper").removeClass("is-show"), y.removeClass("toggled"), y.html('<i class="icon-menu"></i>'), C = 0) : ($(".wrapper").addClass("is-show"), y.addClass("toggled"), y.html('<i class="icon-options-vertical"></i>'), C = 1), $(window).resize()
    }), g = !0, $(".sidebar").mouseenter(function () {
...
function changeContainer() {
    !0 == showSignIn ? containerSignIn.css("display", "block") : containerSignIn.css("display", "none"), !0 == showSignUp ? containerSignUp.css("display", "block") : containerSignUp.css("display", "none")
}
